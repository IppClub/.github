...
| **游戏技术** | **Dora-SSR** | 跨平台的游戏引擎，内置 Web IDE 和 Coding Agent，提供便捷的游戏开发和编程学习环境，适用于移动、嵌入式设备及掌机上的游戏开发。 | [链接](https://github.com/ippclub/Dora-SSR) |
...
| | **Dora-Demo** | 一个用于演示 Dora SSR 引擎的游戏示例项目。 | [链接](https://github.com/ippclub/Dora-Demo) |
